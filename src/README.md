...
Teacher credentials are stored in `teachers.json` for this exercise. The sample login is
`teacher` / `mergington-teacher`; replace it before deploying the application.
